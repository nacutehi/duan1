 ...
 */
 ...
 static{
     ...
     String file = "com/qlquannet/icons/fpt.png";      //icon là thư mục con của src
 ...
 */
 public static boolean saveLogo(File file){
     File dir = new File("src\\main\\resources\\com\\qlquannet\\logos");  //khai báo thư mục logos ngang hàng với src
 ...
 */
 public static ImageIcon readLogo(String fileName){
    File path = new File("src\\main\\resources\\com\\qlquannet\\logos", fileName);
